...
function WebGLIndexedBufferRenderer( gl, extensions, info ) {
	...
	function renderMultiDraw( starts, counts, drawCount ) {
		...
		if (!extension) { console.error("well, sadly ur device / browser doesn't supports WEBGL_multi_draw T-T"); return; }
...
class WebGLRenderer {
	...
	constructor( parameters = {} ) {
		...
		//----Custom multi draw call-----

		this.drawRanges = function ( camera, scene, geometry, material, object, group ) {
			...
			renderer.renderMultiDraw( object.drawRangesOffsets, object.drawRangesCount, object.drawRangesCounts );
